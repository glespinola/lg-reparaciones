...
const SectionCompra = ({title, text, requisitos, date, price, priceCourseModal, linkCompra}) => {
  return (
      ...
      <div className="parent1">
        ...
        <div className="modal">
          <div className="flex">
            ...
            <ModalCompra price={priceCourseModal}/>
          </div>
        </div>
        <div className="space-y">
        ...
        <div className="space-y">
          <a className="btn-cta t-200" href={linkCompra} target="_blank" rel="noreferrer">
